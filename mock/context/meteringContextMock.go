...
var _ wasmvm.MeteringContext = (*MeteringContextMock)(nil)
...
func (m *MeteringContextMock) DeductInitialGasForDirectDeployment(_ wasmvm.CodeDeployInput) error {
	return m.Err
}

// DeductInitialGasForIndirectDeployment mocked method
func (m *MeteringContextMock) DeductInitialGasForIndirectDeployment(_ wasmvm.CodeDeployInput) error {
	return m.Err
}
